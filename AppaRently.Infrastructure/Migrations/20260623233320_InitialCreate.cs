        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Apartments_Price_Positive", "\"Price\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Reservations_CheckOut_After_CheckIn", "\"CheckOut\" > \"CheckIn\"");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5d4e5e4f-5f1e-4f4e-8f7f-9d6f7c2c4a01", "5d4e5e4f-5f1e-4f4e-8f7f-9d6f7c2c4a01", "Client", "CLIENT" },
                    { "8a8a91f9-1d0b-4c67-9f56-0d0f7cc3f1b2", "8a8a91f9-1d0b-4c67-9f56-0d0f7cc3f1b2", "Owner", "OWNER" },
                    { "d7b8d7dd-8d7b-4ef5-8f5b-0f2d4d7d4a11", "d7b8d7dd-8d7b-4ef5-8f5b-0f2d4d7d4a11", "SuperAdmin", "SUPERADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartments_DeletedAt",
                table: "Apartments",
                column: "DeletedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Apartments_Department",
                table: "Apartments",
                column: "Department");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ApartmentId_CheckIn_CheckOut",
                table: "Reservations",
                columns: new[] { "ApartmentId", "CheckIn", "CheckOut" });

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_DeletedAt",
                table: "Reservations",
                column: "DeletedAt");
